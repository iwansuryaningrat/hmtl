    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Formulir Tambah Kegiatan</h4>
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="/add/addkalenderform">Formulir Tambah Kegiatan</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form action="/add/addkegiatan" method="POST">
                            <?= csrf_field(); ?>
                            <div class="card-body">
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="kegiatan" name="kegiatan" placeholder="Masukkan nama kegiatan..." required autofocus>
                                        <!--  -->
                                    </div>
                                </div> <!-- end kegiatan -->
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="Tambahkan keterangan..." required autofocus>
                                        <!--  -->
                                    </div>
                                </div> <!-- end keterangan -->
