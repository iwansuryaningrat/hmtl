    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Formulir Tambah Pengurus</h4>
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="/add/addpengurusform">Formulir Tambah Pengurus</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Tambah Pengurus</div>
                            <div class="card-category">Masukkan data pengurus dengan sebenar-benarnya</div>
                        </div>
                        <form action="/add/addpengurus" method="POST" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="card-body">
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="pengurus" name="pengurus" placeholder="Masukkan nama pengurus..." required autofocus>
                                        <!--  -->
                                    </div>
                                </div> <!-- end pengurus -->
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="nim" name="nim" placeholder="Masukkan nim pengurus..." required autofocus>
                                        <!--  -->
                                    </div>
                                </div> <!-- end nim -->
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="jabatan" name="jabatan" placeholder="Masukkan jabatan..." required autofocus>
                                        <!--  -->
                                    </div>
                                </div> <!-- end jabatan -->
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="angkatan" name="angkatan" placeholder="Masukkan angkatan..." required autofocus>
                                        <!--  -->
                                    </div>
                                </div> <!-- end angkatan -->
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="ig" name="ig" placeholder="Masukkan link instagram..." autofocus>
                                        <!--  -->
                                    </div>
                                </div> <!-- end ig -->
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="linkedin" name="linkedin" placeholder="Masukkan link linkedin..." autofocus>
                                        <!--  -->
                                    </div>
                                </div> <!-- end linkedin -->
