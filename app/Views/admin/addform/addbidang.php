    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Formulir Tambah Bidang</h4>
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="/add/addbidangform">Formulir Tambah Bidang</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Tambah Bidang</div>
                            <div class="card-category">Masukkan data bidang dengan sebenar-benarnya</div>
                        </div>
                        <form action="/add/addbidang" method="POST">
                            <?= csrf_field(); ?>
                            <div class="card-body">
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan nama bidang..." required autofocus>
                                        <!--  -->
                                    </div>
                                </div> <!-- end nama -->
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <br>
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <textarea class="form-control" name="profil" id="profil" cols="30" rows="10">Tambahkan Profil Bidang </textarea>
                                    </div>
                                </div> <!-- end profil -->
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <br>
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <textarea class="form-control" name="deskripsi" id="deskripsi" cols="30" rows="10">Tambahkan Deskripsi Bidang </textarea>
                                    </div>
                                </div> <!-- end deskripsi -->
