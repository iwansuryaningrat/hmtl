    ...
    <div class="container">
        <div class="page-inner">
            <div class="page-header">
                <h4 class="page-title">Formulir Edit Biro</h4>
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="/edit/editbiroform/<?= $data['id']; ?>">Formulir Edit Biro</a>
                    </li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Edit Biro</div>
                            <div class="card-category">Masukkan data biro dengan sebenar-benarnya</div>
                        </div>
                        <form action="/edit/editbiro/<?= $data['id']; ?>" method="POST" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="card-body">
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan nama biro..." value="<?= $data['nama']; ?>" required autofocus>
                                        <!--  -->
                                    </div>
                                </div> <!-- end nama -->
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="ketua" name="ketua" placeholder="Masukkan nama ketua biro..." value="<?= $data['ketua']; ?>" required autofocus>
                                    </div>
                                </div> <!-- end ketua -->
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="angkatan_ketua" name="angkatan_ketua" placeholder="Masukkan Angkatan Ketua biro..." value="<?= $data['angkatan_ketua']; ?>" required autofocus>
                                    </div>
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="wakil" name="wakil" placeholder="Masukkan nama wakil biro..." value="<?= $data['wakil']; ?>" required autofocus>
                                    </div>
                                </div> <!-- end wakil -->
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="angkatan_wakil" name="angkatan_wakil" placeholder="Masukkan angkatan wakil biro..." value="<?= $data['angkatan_wakil']; ?>" required autofocus>
                                    </div>
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="ig" name="ig" placeholder="Masukkan Link Instagram..." value="<?= $data['ig']; ?>" required autofocus>
                                    </div>
                                </div> <!-- end ig -->
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="yt" name="yt" placeholder="Masukkan Link Youtube..." value="<?= $data['yt']; ?>" autofocus>
                                    </div>
                                </div> <!-- end yt -->
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="line" name="line" placeholder="Masukkan Link Line..." value="<?= $data['line']; ?>" autofocus>
                                    </div>
                                </div> <!-- end line -->
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="fb" name="fb" placeholder="Masukkan Link Facebook..." value="<?= $data['fb']; ?>" autofocus>
                                    </div>
                                </div> <!-- end fb -->
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <input type="text" class="form-control" id="web" name="web" placeholder="Masukkan Link Website..." value="<?= $data['web']; ?>" autofocus>
                                    </div>
                                </div> <!-- end web -->
                                ...
                                <div class="form-group form-show-validation row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-sm-8">
                                        <div class="input-file input-file-image">
                                            <img class="img-upload-preview" width="100" height="100" src="/img/biro/<?= $data['logo']; ?>" alt="preview">
