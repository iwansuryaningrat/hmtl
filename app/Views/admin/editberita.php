                                ...
                                <form action="/add/addnews" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group form-show-validation row">
                                            ...
                                            <br>
                                            <div class="col-lg-7 col-md-9 col-sm-8">
                                                <textarea class="form-control" name="preview" id="preview" cols="30" rows="10" value="<?= $news['preview']; ?>">
												</textarea>
                                            </div>
                                        </div> <!-- end preview -->
                                        ...
                                        <div class="form-group form-show-validation row">
                                            ...
                                            <br>
                                            <div class="col-lg-7 col-md-9 col-sm-8">
                                                <textarea class="form-control" name="isi" id="isi" cols="30" rows="10" value="<?= $news['isi']; ?>">
												</textarea>
                                            </div>
                                        </div> <!-- end isi -->
                                        ...
                                        <div class="form-group form-show-validation row">
                                            ...
                                            <div class="col-lg-7 col-md-9 col-sm-8">
                                                <div class="input-file input-file-image">
                                                    <img class="img-upload-preview" width="100" height="100" src="/admin/assets/img/<?= $news['foto']; ?>" alt="preview">
