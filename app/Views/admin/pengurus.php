        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="/admin/pengurus">Daftar Pengurus</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="/add/addpengurusform" class="ml-auto">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        ...
                                                        <a href="/delete/deletepengurus/<?= $data['id']; ?>">
...
<?php if (session()->getFlashdata('pengurus')) : ?>
    <script>
        $.notify({
            icon: "flaticon-alarm-1",
            title: "Congratulation!!",
            message: "<?= session()->getFlashdata('pengurus'); ?>",
        }, {
            type: "success",
            placement: {
                from: "bottom",
