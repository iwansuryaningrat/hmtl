                        ...
                        <table class="table">
                          <tbody>
                            <tr>
                              <td>
                                <div class="flag">
                                  <img src="/admin/assets/img/flags/id.png" alt="indonesia" />
                                </div>
                              </td>
                              <td>Indonesia</td>
                            ...
                            <tr>
                              <td>
                                <div class="flag">
                                  <img src="/admin/assets/img/flags/us.png" alt="united states" />
                                </div>
                              </td>
                              <td>USA</td>
                            ...
                            <tr>
                              <td>
                                <div class="flag">
                                  <img src="/admin/assets/img/flags/au.png" alt="australia" />
                                </div>
                              </td>
                              <td>Australia</td>
                            ...
                            <tr>
                              <td>
                                <div class="flag">
                                  <img src="/admin/assets/img/flags/ru.png" alt="russia" />
                                </div>
                              </td>
                              <td>Russia</td>
                            ...
                            <tr>
                              <td>
                                <div class="flag">
                                  <img src="/admin/assets/img/flags/cn.png" alt="china" />
                                </div>
                              </td>
                              <td>China</td>
                            ...
                            <tr>
                              <td>
                                <div class="flag">
                                  <img src="/admin/assets/img/flags/br.png" alt="brazil" />
                                </div>
                              </td>
                              <td>Brasil</td>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card">
                ...
                <div class="card-body pb-0">
                  <div class="d-flex">
                    <div class="avatar">
                      <img src="/admin/assets/img/logoproduct.svg" alt="..." class="avatar-img rounded-circle" />
                    </div>
                  ...
                  <div class="d-flex">
                    <div class="avatar">
                      <img src="/admin/assets/img/logoproduct3.svg" alt="..." class="avatar-img rounded-circle" />
                    </div>
                    <div class="flex-1 pt-1 ml-2">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="card-list">
                    <div class="item-list">
                      <div class="avatar">
                        <img src="/admin/assets/img/jm_denis.jpg" alt="..." class="avatar-img rounded-circle" />
                      </div>
                    ...
                    <div class="item-list">
                      <div class="avatar">
                        <img src="/admin/assets/img/chadengle.jpg" alt="..." class="avatar-img rounded-circle" />
                      </div>
                      <div class="info-user ml-3">
                    ...
                    <div class="item-list">
                      <div class="avatar">
                        <img src="/admin/assets/img/talha.jpg" alt="..." class="avatar-img rounded-circle" />
                      </div>
                      <div class="info-user ml-3">
                    ...
                    <div class="item-list">
                      <div class="avatar">
                        <img src="/admin/assets/img/mlane.jpg" alt="..." class="avatar-img rounded-circle" />
                      </div>
                      <div class="info-user ml-3">
            ...
            <div class="col-md-4">
              <div class="card card-primary bg-primary-gradient">
                <div class="card-body">
                  <h4 class="mt-3 b-b1 pb-2 mb-4 fw-bold">
                    Active user right now
                  </h4>
                  <h1 class="mb-4 fw-bold">17</h1>
                  <h4 class="mt-3 b-b1 pb-2 mb-5 fw-bold">
    ...
    <div class="quick-sidebar">
      ...
      <div class="quick-sidebar-wrapper">
        <ul class="nav nav-tabs nav-line nav-color-secondary" role="tablist">
          <li class="nav-item">
            <a class="nav-link active show" data-toggle="tab" href="#messages" role="tab" aria-selected="true">Messages</a>
          </li>
          <li class="nav-item">
                ...
                <div class="quick-scroll scrollbar-outer">
                  <div class="quick-content contact-content">
                    ...
                    <div class="avatar-group">
                      <div class="avatar">
                        <img src="/admin/assets/img/jm_denis.jpg" alt="..." class="
                              avatar-img
                              rounded-circle
                              border border-white
                            " />
                      ...
                      <div class="avatar">
                        <img src="/admin/assets/img/chadengle.jpg" alt="..." class="
                              avatar-img
                              rounded-circle
                              border border-white
                            " />
                      ...
                      <div class="avatar">
                        <img src="/admin/assets/img/mlane.jpg" alt="..." class="
                              avatar-img
                              rounded-circle
                              border border-white
                            " />
                      ...
                      <div class="avatar">
                        <img src="/admin/assets/img/talha.jpg" alt="..." class="
                              avatar-img
                              rounded-circle
                              border border-white
                            " />
                ...
                <div class="message-content-wrapper">
                  <div class="message message-in">
                    ...
                    <div class="message-body">
                      ...
                      <div class="message-content">
                        <div class="content">
                          When is the deadline of the project we are working
                          on ?
                        </div>
                      </div>
                  ...
                  <ul class="tasks-list">
                    ...
                    <li>
                      <label class="
                            ...
                            checkbox-secondary
                          ">
                        <input type="checkbox" class="custom-control-input" /><span class="custom-control-label">Create the main structure
                        </span>
                        <span class="task-action">
                          <a href="#" class="link text-danger">
                            <i class="flaticon-interface-5"></i>
                  ...
                  <ul class="tasks-list">
                    <li>
                      <label class="
                            ...
                            checkbox-secondary
                          ">
                        <input type="checkbox" class="custom-control-input" /><span class="custom-control-label">Initialize the project
                        </span>
                        <span class="task-action">
                          <a href="#" class="link text-danger">
                            <i class="flaticon-interface-5"></i>
                    ...
                    <li>
                      <label class="
                            ...
                            checkbox-secondary
                          ">
                        <input type="checkbox" class="custom-control-input" /><span class="custom-control-label">Updates changes to GitHub
                        </span>
                        <span class="task-action">
                          <a href="#" class="link text-danger">
                            <i class="flaticon-interface-5"></i>
                    ...
                    <li>
                      <label class="
                            ...
                            checkbox-secondary
                          ">
                        <input type="checkbox" class="custom-control-input" /><span title="This task is too long to be displayed in a normal space!" class="custom-control-label">This task is too long to be displayed in a normal
                          space!
                        </span>
                        <span class="task-action">
                          <a href="#" class="link text-danger">
