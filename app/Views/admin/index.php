                            ...
                            <tbody>
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="/admin/assets/img/flags/id.png"
                                      alt="indonesia"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="/admin/assets/img/flags/us.png"
                                      alt="united states"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="/admin/assets/img/flags/au.png"
                                      alt="australia"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="/admin/assets/img/flags/ru.png"
                                      alt="russia"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="/admin/assets/img/flags/cn.png"
                                      alt="china"
                                    />
                                  </div>
                                </td>
                              ...
                              <tr>
                                <td>
                                  <div class="flag">
                                    <img
                                      src="/admin/assets/img/flags/br.png"
                                      alt="brazil"
                                    />
                                  </div>
                                </td>
                ...
                <div class="card">
                  ...
                  <div class="card-body pb-0">
                    <div class="d-flex">
                      <div class="avatar">
                        <img
                          src="/admin/assets/img/logoproduct.svg"
                          alt="..."
                          class="avatar-img rounded-circle"
                        />
                      </div>
                    ...
                    <div class="d-flex">
                      <div class="avatar">
                        <img
                          src="/admin/assets/img/logoproduct3.svg"
                          alt="..."
                          class="avatar-img rounded-circle"
                        />
                      </div>
                      <div class="flex-1 pt-1 ml-2">
                        ...
                        <small class="text-muted"
                          >Bootstrap 4 Admin Dashboard</small
                        >
                      </div>
                      <div class="d-flex ml-auto align-items-center">
      ...
      <div class="quick-sidebar">
        ...
        <div class="quick-sidebar-wrapper">
          ...
          <div class="tab-content mt-3">
            <div
              class="tab-chat tab-pane fade show active"
              id="messages"
              role="tabpanel"
            >
                        ...
                        <div class="user">
                          <a href="#">
                            ...
                            <div class="user-data">
                              ...
                              <span class="message"
                                >Ready for the meeting today with...</span
                              >
                            </div>
                          </a>
                        </div>
                      ...
                      <li>
                        ...
                        >
                          ...
                          /><span class="custom-control-label"
                            >Planning new project structure</span
                          >
                      ...
                      <li>
                        ...
                        >
                          <input
                            ...
                            class="custom-control-input"
                          /><span class="custom-control-label"
                            >Finalise the design proposal</span
                          >
                          <span class="task-action">
                            <a href="#" class="link text-danger">
                              <i class="flaticon-interface-5"></i>
