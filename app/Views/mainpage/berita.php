			...
			<div class="container">
				<div class="body__section">
					<div class="info__akademik__body row">
						<!-- info akademik main -->
						<div class="info__akademik__main col-lg-9 col-md-9 ps-lg-0">
							...
							<div class="info__akademik__content row">
								...
								<div class="berita__info__akademik col-lg-6 col-md-6 mb-5">
									<div class="info__akademik__card">
										<a href="#view-berita" class="akademik__card">
						...
						<div class="info__aside__content col-lg-3 col-md-3 pe-lg-0">
							<div class="akademik__aside_body">
							...
							<div class="info__beasiswa__content row">
								<div class="berita__info__beasiswa col-lg-6 col-md-6 mb-5">
									<div class="info__beasiswa__card">
										<a href="berita.html" class="beasiswa__card">
