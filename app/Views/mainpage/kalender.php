...
<head>
    ...
    <meta property="og:title" content="Kalender Himpunan Mahasiwa Teknik Lingkungan Undip" /> <!-- title shown in the actual shared post -->
	    ...
	    <div class="container-fluid">
	        ...
	        <div class="collapse navbar-collapse" id="navbarWithDropdown">
	            <ul class="navbar-nav ms-auto">
	                ...
	                <li class="nav-item">
	                    <a class="nav-link nav__font active" href="kalender.html">
	                    	<span>Kalender</span>
	                    </a>
	                </li>
	                <li class="nav-item">
