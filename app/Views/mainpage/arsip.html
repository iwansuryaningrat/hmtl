...
<head>
    ...
    <meta property="og:title" content="Arsip Himpunan Mahasiswa Teknik Lingkungan UNDIP" /> <!-- title shown in the actual shared post -->
    ...
    <!-- Webpage Title -->
    <title>Arsip - HMTL | Universitas Diponegoro</title>
