...
<head>
    ...
    <meta property="og:title" content="Profil Himpunan Mahasiwa Teknik Lingkungan Undip" /> <!-- title shown in the actual shared post -->
    ...
    <!-- Webpage Title -->
    <title>Profil - HMTL | Universitas Diponegoro</title>
