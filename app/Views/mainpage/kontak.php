...
<body>
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-7 ps-lg-5 ps-md-3 d-flex align-items-center">
						<div id="socmed__content" class="owl-carousel owl-theme">
							<div class="item">
								<a class="owl__ilink" href="https://www.instagram.com/hmtlundip/" target="_blank"><img src="assets/images/instagram-color2.svg" alt="alter-igcolor1"></a>
							</div>
							<div class="item">
								<a class="owl__ilink" href="#linkedin"><img src="assets/images/linkedin-color1.svg" alt="alter-linkedincolor1"></a>
							</div>
							<div class="item">
								<a class="owl__ilink" href="https://www.youtube.com/channel/UCTaPUsgMZ7zhE7ppnrI3iAA" target="_blank"><img src="assets/images/youtube-color1.svg" alt="alter-youtubecolor1"></a>
							</div>
							<div class="item">
								<a class="owl__ilink" href="#line"><img src="assets/images/line-color.svg" alt="alter-linecolor"></a>
							</div>
							<div class="item">
								<a class="owl__ilink" href="https://open.spotify.com/show/1QYjVqMmu31mIS2T2WY555?si=do6hUAx6RN6pVco9I69kZw" target="_blank"><img src="assets/images/spotify-color.svg" alt="alter-spotifycolor"></a>
							</div>
						</div>
	...
	<!-- search section offcanvas --> <!-- FINISH -->
